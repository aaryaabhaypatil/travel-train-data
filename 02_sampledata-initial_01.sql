...
-- CardLimit: cardid, userid, cardtypeid, expiry, balance, cap_limit
INSERT INTO CardLimit(cardtypeid, userid, expiry, balance, cap_limit) VALUES (1,1,now()+ interval '1 year',100, 10);
INSERT INTO CardLimit(cardtypeid, userid, expiry, balance, cap_limit) VALUES (2,1,now()+ interval '1 year',20, 20);
INSERT INTO CardLimit(cardtypeid, userid, expiry, balance, cap_limit) VALUES (3,2,now()+ interval '1 year',30, 15);
INSERT INTO CardLimit(cardtypeid, userid, expiry, balance, cap_limit) VALUES (1,2,now()+ interval '1 year',500, 30);
INSERT INTO CardLimit(cardtypeid, userid, expiry, balance, cap_limit) VALUES (4,3,now()+ interval '1 year',6, 5);
INSERT INTO CardLimit(cardtypeid, userid, expiry, balance, cap_limit) VALUES (7,3,now()+ interval '1 year',4, 25);
